...
import com.onoo.gomlgy.Presentation.presenters.RegisterPresenter;
        ...
        btn_signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(input_email.getText().toString().length() <= 0){
                    ...
                    til.setError(getString(R.string.email_is_required));
                    isValid = false;
                }

                if(input_password.getText().toString().length() <= 5){
                    TextInputLayout til = (TextInputLayout) findViewById(R.id.input_password_layout);
                    til.setError(getString(R.string.password_is_required_and_must_be_6_characters_at_least));
                    isValid = false;
                }
...
//                    til.setError(getString(R.string.confirm_password_mismatch_with_password));
//                    isValid = false;
//                }
