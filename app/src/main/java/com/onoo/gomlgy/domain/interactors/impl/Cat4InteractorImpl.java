...
public class Cat4InteractorImpl extends AbstractInteractor {
    private Cat4Interactor.CallBack mCallback;
    private Cat1ApiInterface apiService;
    int subCat;

    public Cat4InteractorImpl(Executor threadExecutor, MainThread mainThread, Cat4Interactor.CallBack callBack, int subCat) {
    ...
    public void run() {
        ...
        call.enqueue(new Callback<ProductListingResponse>() {
            ...
            public void onResponse(Call<ProductListingResponse> call, Response<ProductListingResponse> response) {
                try {
                    mCallback.onCat4ProductDownloaded(response.body().getData());
                } catch (Exception e) {
            ...
            public void onFailure(Call<ProductListingResponse> call, Throwable t) {
                mCallback.onCat4ProductDownloadError();
            }
        });
