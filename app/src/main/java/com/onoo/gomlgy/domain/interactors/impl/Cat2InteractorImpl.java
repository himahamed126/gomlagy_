...
public class Cat2InteractorImpl extends AbstractInteractor {
    private Cat2Interactor.CallBack mCallback;
    private Cat1ApiInterface apiService;
    int subCat;

    public Cat2InteractorImpl(Executor threadExecutor, MainThread mainThread, Cat2Interactor.CallBack callBack, int subCat) {
    ...
    public void run() {
        ...
        call.enqueue(new Callback<ProductListingResponse>() {
            ...
            public void onResponse(Call<ProductListingResponse> call, Response<ProductListingResponse> response) {
                try {
                    mCallback.onCat2ProductDownloaded(response.body().getData());
                } catch (Exception e) {
            ...
            public void onFailure(Call<ProductListingResponse> call, Throwable t) {
                mCallback.onCat2ProductDownloadError();
            }
        });
