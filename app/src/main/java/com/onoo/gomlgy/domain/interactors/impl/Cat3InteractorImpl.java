...
public class Cat3InteractorImpl extends AbstractInteractor {
    private Cat3Interactor.CallBack mCallback;
    private Cat1ApiInterface apiService;
    int subCat;

    public Cat3InteractorImpl(Executor threadExecutor, MainThread mainThread, Cat3Interactor.CallBack callBack, int subCat) {
    ...
    public void run() {
        ...
        call.enqueue(new Callback<ProductListingResponse>() {
            ...
            public void onResponse(Call<ProductListingResponse> call, Response<ProductListingResponse> response) {
                try {
                    mCallback.onCat3ProductDownloaded(response.body().getData());
                } catch (Exception e) {
            ...
            public void onFailure(Call<ProductListingResponse> call, Throwable t) {
                mCallback.onCat3ProductDownloadError();
            }
        });
